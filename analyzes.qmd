...
mcplot(out, var_y = "es", var_x = 1, var_shape = 2, template = "power")
...
```{r}
mctable(out, var_y = "es", wider = "statistic", format = "html", digits = 0)
```
